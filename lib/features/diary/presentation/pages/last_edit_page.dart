...
class LastEdit extends StatefulWidget {
  final List<XFile> initialImages;
  final Function(List<XFile>) onImagesSelected;

  LastEdit({required this.initialImages, required this.onImagesSelected});

  @override
  _LastEditState createState() => _LastEditState();
}

class _LastEditState extends State<LastEdit> {
...
// 사진촬영
  ...
  void _handleRegistrationButton() {
    if (_pickedImages.isEmpty ||
      ...
      Navigator.pop(
        context,
        _pickedImages.whereType<XFile>().toList(),
      );
    }
  }
